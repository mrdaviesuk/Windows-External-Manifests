...
> Note: As ever, before making any changes to the registry it's good practive to take a backup.  
...
There are .reg files in the repository, to add and remove this entry. 
